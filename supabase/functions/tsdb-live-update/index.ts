...
// IMPORTANT: only include genuine connectors / generic suffixes here.
// Never include actual team-name tokens like "gremio", "atletico", "united", "city",
// otherwise both sides collapse to "" and similarity drops to 0.
const STOP = new Set([
