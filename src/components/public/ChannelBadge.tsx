...
const CHANNEL_MAP: Record<string, ChannelConfig> = {
  ...
  cazétv:       { emoji: "🎮", text: "text-lime-300",    border: "border-lime-500/40",    gradient: "from-lime-500/30 to-green-600/20",      glow: "shadow-[0_0_12px_rgba(132,204,22,0.2)]", short: "Cazé", domain: "cazetv.com.br", localLogo: "/channels/cazetv.png" },
  cazetv:       { emoji: "🎮", text: "text-lime-300",    border: "border-lime-500/40",    gradient: "from-lime-500/30 to-green-600/20",      glow: "shadow-[0_0_12px_rgba(132,204,22,0.2)]", short: "Cazé", domain: "cazetv.com.br", localLogo: "/channels/cazetv.png" },
