...
const BannerCard = ({ banner, index }: { banner: { id: string; image_url: string; title: string | null }; index: number }) => {
  ...
  return (
    ...
    >
      <div className="group relative overflow-hidden rounded-xl border border-border/10 bg-card transition-all duration-250 hover:scale-[1.03] hover:shadow-[0_8px_32px_rgba(0,0,0,0.5)] cursor-pointer">
        {!imgErr ? (
          <img
          ...
          <div className="w-full aspect-[4/3] flex flex-col items-center justify-center bg-card gap-1.5">
